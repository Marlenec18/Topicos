...
public class ProductosDAO {
    ...
    public void insProducto(){
        ...
        String query = "insert into tbl_Productos " +
                "(nomProductos,precio,costo,existencia,vigente,idProveedor) " +
    ...
    public void updProducto(){
        String query = "update tbl_Productos set nomProductos='"+nomProducto+"'" +
    ...
    public void delProducto(){
        String query = "delete from tbl_Productos where idProductos="+idProducto;
        try{
            Statement stmt = con.createStatement();
            stmt.executeUpdate(query);
        }catch (Exception e){}
    ...
    public ObservableList<ProductosDAO> seeAllProducto(){

        ObservableList<ProductosDAO> listaP = FXCollections.observableArrayList();
        ProductosDAO objP = null;
        String query = "select * from tbl_Productos order by nomProductos";
        try{
            Statement stmt = con.createStatement();
            ...
            while(res.next()){
                ...
                objP.setNomProducto(res.getString("nomProductos"));
